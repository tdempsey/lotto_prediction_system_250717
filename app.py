...
def load_rank_limits(file_path='rank_limit_100.csv'):
    """
    Load rank limits from CSV file. These limits specify 
    ...
    try:
        with open(file_path, 'r') as f:
            ...
            return [int(limit) for limit in limit_data]
...
def load_rank_counts(file_path='rank_count_100.csv'):
    """
    Load rank counts from CSV file. These values represent 
    ...
    try:
        with open(file_path, 'r') as f:
            ...
            return [int(count) for count in count_data]
    except Exception as e:
        print(f"Error loading rank counts: {e}")
        # Default fallback values based on the file you provided
